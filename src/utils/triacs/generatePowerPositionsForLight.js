...
const generatePowerPositionsForLight = (lightConfig, tickCount) => {
  const { isAlwaysOn, startFadeIn, startFadeOut, fadeFor } = lightConfig;
...
export default generatePowerPositionsForLight;
